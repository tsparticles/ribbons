const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/EmitterInstance-f5CLZm_t.js","assets/Constants-Boin98lu.js","assets/MathUtils-DBT3t4S6.js","assets/TypeUtils-CAcPJyQQ.js","assets/Utils-BJNts6wb.js","assets/index-D8FjBiWF.js","assets/index-8NWtx1MX.css"])))=>i.map(i=>d[i]);
import { i as isNumber } from "./TypeUtils-CAcPJyQQ.js";
import { S as __vitePreload, t as Emitter } from "./index-D8FjBiWF.js";
...
var EmittersInstancesManager = class {
	...
	async addEmitter(container, options, position) {
		...
		const { EmitterInstance } = await __vitePreload(async () => {
			const { EmitterInstance } = await import("./EmitterInstance-f5CLZm_t.js");
